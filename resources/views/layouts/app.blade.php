...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow">
        <div class="container">
            <a class="navbar-brand text-light fw-bold" href="{{ route('products.index') }}">&#x1F4E6; Product
                Management</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-light me-2" href="{{ route('products.index') }}">&#x1F4CB;
                            All Products</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-success me-2" href="{{ route('products.create') }}">&#x2795;
                            Add Product</a>
                    </li>
                    ...
                    @auth
                        ...
                        @endphp
                        <li class="nav-item">
                            <a class="nav-link btn btn-outline-warning position-relative me-2"
                    ...
                    @else
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn btn-outline-secondary" href="{{ route('register') }}">&#x1F4DD;
                                Register</a>
                        </li>
                    @endauth
                    @auth
                        <li class="nav-item">
                            <a class="nav-link btn btn-outline-info position-relative me-2"
